...
public class CCSpinnerRegionAdapter extends BaseAdapter implements SpinnerAdapter {

    private final Context activity;
    private ArrayList<Region> asr;

    public CCSpinnerRegionAdapter(Context context, ArrayList<Region> asr) {
        this.asr=asr;
        activity = context;
    }
