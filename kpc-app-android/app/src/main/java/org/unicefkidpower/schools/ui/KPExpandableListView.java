...
public class KPExpandableListView extends ExpandableListView {
	...
	private static final String TAG = KPExpandableListAdapter.class.getSimpleName();
	...
	private KPExpandableListAdapter adapter;

	public KPExpandableListView(Context context) {
		super(context);
	}

	public KPExpandableListView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public KPExpandableListView(Context context, AttributeSet attrs, int defStyle) {
	...
	public void setAdapter(ExpandableListAdapter adapter) {
		...
		if(adapter instanceof KPExpandableListAdapter) {
			this.adapter = (KPExpandableListAdapter) adapter;
	 ...
	 */
	public static abstract class KPExpandableListAdapter extends BaseExpandableListAdapter {
		private SparseArray<GroupInfo> groupInfo = new SparseArray<GroupInfo>();
		private KPExpandableListView parent;

		private static final int STATE_IDLE = 0;
		private static final int STATE_EXPANDING = 1;
		private static final int STATE_COLLAPSING = 2;

		private void setParent(KPExpandableListView parent) {
			this.parent = parent;
		}
