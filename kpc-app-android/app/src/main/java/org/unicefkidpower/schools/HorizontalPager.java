 ...
 * {@link com.aquaticsafetyconceptsllc.iswimband.HorizontalPager#setOnScreenSwitchListener(com.aquaticsafetyconceptsllc.iswimband.HorizontalPager.OnScreenSwitchListener)} in order to perform
...
//		}
	...
	public void computeScroll() {
		if (mScroller.computeScrollOffset()) {
			...
			if (mOnScreenSwitchListener != null) {
				mOnScreenSwitchListener.onScreenSwitched(oldScreen, mCurrentScreen);
			}
	...
	/**
	 * Sets the {@link com.aquaticsafetyconceptsllc.iswimband.HorizontalPager.OnScreenSwitchListener}.
	 *
	...
	public static interface OnScreenSwitchListener {
		 ...
		 *
		 * @param oldscreen The old screen index.
		 * @param screen    The new screen index.
		 */
		void onScreenSwitched(int oldscreen, int screen);
	}
