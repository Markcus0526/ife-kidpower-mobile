...
import org.unicefkidpower.kid_power.View.CustomControls.KPHCreditCardEntry.internal.CreditCardEntry;
        ...
        if (!isInEditMode()) {
            ...
            if (attrs != null) {
                ...
                try {
                    ...
                    this.textHelperColor = typedArray.getColor(R.styleable.CreditCardForm_helper_text_color, UIManager.sharedInstance().getColor(R.color.credit_card_text_helper_color));
            ...
            if (inputBackground == null) {
                ...
                inputBackground = UIManager.sharedInstance().getDrawable(R.drawable.credit_card_entry_background_white);
            }
        }
