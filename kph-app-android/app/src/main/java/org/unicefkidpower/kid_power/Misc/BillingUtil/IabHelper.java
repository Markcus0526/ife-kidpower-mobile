...
public class IabHelper {
	private static final String TAG = "In-app Helper";

	// Is debug logging enabled?
	private boolean		debugLog = false;
	private String		debugTag = "IabHelper";
	...
	public void startSetup(final OnIabSetupFinishedListener listener) {
		...
		if (context != null && !context.getPackageManager().queryIntentServices(serviceIntent, 0).isEmpty()) {
	...
	public void launchPurchaseFlow(Activity act,
		...
		try {
			...
			IabHelper.this.requestCode = requestCode;
	...
	public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
		IabResult result;
		if (requestCode != IabHelper.this.requestCode)
			return false;
		...
		if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
			...
			if (purchaseListener != null) {
				purchaseListener.onIabPurchaseFinished(new IabResult(BILLING_RESPONSE_RESULT_OK, "Success"), purchase);
			}
	...
	public void queryInventoryAsync(final boolean querySkuDetails,
		...
		Logger.log(TAG, "queryInventoryAsync : Buy Credit");
	...
	void consume(Purchase itemInfo) throws IabException {
		Logger.log(TAG, "Consume : purchase");
	...
	public boolean isAvailablePurchase() {
		return setupDone && !asyncInProgress;
	}
	...
	int queryPurchases(Inventory inv, String itemType) throws JSONException, RemoteException {
		...
		do {
			...
			if (service == null || context == null || itemType == null) {
				return BILLING_RESPONSE_RESULT_BILLING_UNAVAILABLE;
			}

			Bundle ownedItems = service.getPurchases(3, context.getPackageName(), itemType, continueToken);
