...
public class CmdGetMacAddress extends BandCommand {
	private static final String TAG = "CmdGetMacAddress";

	public CmdGetMacAddress() {
		_code = BandCommand.CODE_GET_MACADDRESS;
	}
