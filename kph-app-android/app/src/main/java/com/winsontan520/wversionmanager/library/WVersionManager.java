...
public class WVersionManager implements IWVersionManager {
	...
	public void checkVersion() {
		...
		if (currentTimeStamp > reminderTimeStamp){
			// fire request to getV1 update version content
			if (!BuildConfig.IS_PRODUCTION){
	...
	public String getMessage() {
		...
		case MODE_CHECK_VERSION:
			...
			break;
		case MODE_ASK_FOR_RATE:
			defaultMessage = activity.getString(R.string.please_rate_us);
			break;
		}
	...
	public String getAskForRatePositiveLabel() {
		return mAskForRatePositiveLabel == null? activity.getString(R.string.ok) : mAskForRatePositiveLabel;
	}
